...
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-inverse" role="navigation">
                <div class="navbar-header">
                    ...
                    <a href="#" class="navbar-brand scroll-top logo"><b>Meilin Profile</b></a>
                </div>
                <!--/.navbar-header-->
    ...
    <section id="home">
        <div class="banner-container">
            <img src="images/banner-photo3.jpg" alt="banner" />
    ...
    <section id="portfolio" class="page-section section appear clearfix secPad">
        <div class="container">
            ...
            <div class="heading text-center">
                <!-- Heading -->
                <h2>Hobbies</h2>
                <p>My personality is quite varied in terms of interests and hobbies, and he enjoys doing and learning a lot of different things.</p>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="heading text-center">
                    ...
                    <p>Thank you for visiting out my profile. Please feel free to contact with me.</p>
                    <p>You can fill out the form, mail me or call me.</p>
                </div>
            </div>
